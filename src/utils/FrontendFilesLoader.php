...
class FrontendFilesLoader {
  ...
  public function frontendFiles() {
    ...
    wp_register_script('vindi_woocommerce_creditcard_js', plugins_url('/assets/js/creditcard.js', plugin_dir_path(__FILE__)), array('jquery', 'imask'), VINDI_VERSION, true);
    wp_register_script('vindi_woocommerce_pix_js', plugins_url('/assets/js/pix.js', plugin_dir_path(__FILE__)), [], VINDI_VERSION, true);
    wp_enqueue_script('vindi_woocommerce_creditcard_js');
    wp_enqueue_script('vindi_woocommerce_pix_js');
    ...
    wp_localize_script(
      'vindi_woocommerce_creditcard_js',
      'vindi_woocommerce',
      array(
